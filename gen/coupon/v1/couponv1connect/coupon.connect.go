...
import (
	...
	context "context"
	v1 "coupon_issuance/gen/coupon/v1"
	errors "errors"
	http "net/http"
	strings "strings"
)
...
const (
	...
	CouponServiceName = "coupon_issuance.v1.CouponService"
)
...
const (
	...
	// CreateCampaign RPC.
	CouponServiceCreateCampaignProcedure = "/coupon_issuance.v1.CouponService/CreateCampaign"
	// CouponServiceGetCampaignProcedure is the fully-qualified name of the CouponService's GetCampaign
	// RPC.
	CouponServiceGetCampaignProcedure = "/coupon_issuance.v1.CouponService/GetCampaign"
	// CouponServiceIssueCouponProcedure is the fully-qualified name of the CouponService's IssueCoupon
	// RPC.
	CouponServiceIssueCouponProcedure = "/coupon_issuance.v1.CouponService/IssueCoupon"
)

// CouponServiceClient is a client for the coupon_issuance.v1.CouponService service.
...
// NewCouponServiceClient constructs a client for the coupon_issuance.v1.CouponService service. By
...
// CreateCampaign calls coupon_issuance.v1.CouponService.CreateCampaign.
...
// GetCampaign calls coupon_issuance.v1.CouponService.GetCampaign.
...
// IssueCoupon calls coupon_issuance.v1.CouponService.IssueCoupon.
...
// CouponServiceHandler is an implementation of the coupon_issuance.v1.CouponService service.
...
func NewCouponServiceHandler(svc CouponServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/coupon_issuance.v1.CouponService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCouponServiceHandler) CreateCampaign(context.Context, *connect.Request[v1.CreateCampaignRequest]) (*connect.Response[v1.CreateCampaignResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("coupon_issuance.v1.CouponService.CreateCampaign is not implemented"))
}
...
func (UnimplementedCouponServiceHandler) GetCampaign(context.Context, *connect.Request[v1.GetCampaignRequest]) (*connect.Response[v1.GetCampaignResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("coupon_issuance.v1.CouponService.GetCampaign is not implemented"))
}
...
func (UnimplementedCouponServiceHandler) IssueCoupon(context.Context, *connect.Request[v1.IssueCouponRequest]) (*connect.Response[v1.IssueCouponResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("coupon_issuance.v1.CouponService.IssueCoupon is not implemented"))
}
